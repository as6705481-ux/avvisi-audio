...
class Products(db.Model):
    ...
    category = db.Column(db.Enum('Electrónica', 'Periféricos', 'Audio', 'Impresoras', 'Otros'), nullable=False, default='Otros')
    created_at = db.Column(db.TIMESTAMP, default=db.func.current_timestamp())
...
class Quotations(db.Model):
    ...
    status = db.Column(db.Enum('pending', 'sent', 'cancelled'), default='pending')

    user = db.relationship('Users', backref=db.backref('quotations', lazy=True))
