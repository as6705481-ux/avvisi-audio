...
\textbf{Lugar de Evento:} TEGUS \\
\textbf{Tipo de evento:} GRADUCION \\
\textbf{N° de Invitados:} 11\\
\textbf{Fecha de Evento:} 2025{-}04{-}11
\begin{flushright}
\vspace{-3.5cm}
...
\begin{table}[h!]
    ...
    \begin{tabularx}{\textwidth}{
        ...
        1 & 1 & {\raggedright\arraybackslash Banda  } & 34000.00 & 34000.00 \\
    
        \arrayrulecolor{primary}\hline
        & & & \textbf{ISV 15\%:} & 0.00 \\
        & & & \textbf{Total:} & + 34000.00 +  \
        rrayrulecolor{primary}
    \end{tabularx}
...
oindentegin{minipage}[t]{0.6	extwidth}
